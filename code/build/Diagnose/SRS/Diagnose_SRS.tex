...
$t$ & Time & ${\text{s}}$
\\
${t_{\text{p}}}$ & Chosen prediction period & ${\text{s}}$
\\
${t_{\text{t}}}$ & Time at second test & ${\text{s}}$
\\
$V$ & Volume & ${\text{mL}}$
\\
...
Description & \begin{symbDescription}
              ...
              \item{${N_{\text{o}}}$ is the initial viral load ($\frac{\text{mol}}{\text{mL}}$)}
              \item{${N_{\text{t}}}$ is the viral load at time t ($\frac{\text{mol}}{\text{mL}}$)}
              \item{${t_{\text{t}}}$ is the time at second test (${\text{s}}$)}
              \end{symbDescription}
\\ \midrule \\
...
Description & \begin{symbDescription}
              ...
              \item{${N_{\text{o}}}$ is the initial viral load ($\frac{\text{mol}}{\text{mL}}$)}
              \item{$λ$ is the elimination constant ($\text{s}^{-1}$)}
              \item{${t_{\text{p}}}$ is the chosen prediction period (${\text{s}}$)}
              \end{symbDescription}
\\ \midrule \\
...
\\
${t_{\text{p}}}$ & ${t_{\text{p}}}\gt{}0$ & $2.592\cdot{}10^{6}$ ${\text{s}}$ & 10$\%$
\\
${t_{\text{t}}}$ & ${t_{\text{t}}}\gt{}0$ & $86.4\cdot{}10^{3}$ ${\text{s}}$ & 10$\%$
\\
\bottomrule
