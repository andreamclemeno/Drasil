...
\midrule
\endhead
${\text{copies}}$ & number of biological units & copies
\\
...
\midrule
\endhead
$N$ & Viral load & $\frac{\text{copies}}{\text{mL}}$
\\
${N_{\text{o}}}$ & Initial viral load & $\frac{\text{copies}}{\text{mL}}$
\\
${N_{\text{p}}}$ & Predicted viral load after 30 days & $\frac{\text{copies}}{\text{mL}}$
\\
${N_{\text{t}}}$ & Viral load at time t & $\frac{\text{copies}}{\text{mL}}$
\\
$n$ & Number of virions & ${\text{copies}}$
\\
$r$ & Rate of change of the viral load & $\frac{\text{copies}}{\text{mL}\text{s}}$
\\
$t$ & Time & ${\text{s}}$
\\
$V$ & Volume & ${\text{mL}}$
...
Description & \begin{symbDescription}
              \item{$r$ is the rate of change of the viral load ($\frac{\text{copies}}{\text{mL}\text{s}}$)}
              \item{$t$ is the time (${\text{s}}$)}
              \item{$N$ is the viral load ($\frac{\text{copies}}{\text{mL}}$)}
...
Description & \begin{symbDescription}
              \item{$N$ is the viral load ($\frac{\text{copies}}{\text{mL}}$)}
              \item{$n$ is the number of virions (${\text{copies}}$)}
...
\\ \midrule \\
Description & \begin{symbDescription}
              \item{${N_{\text{p}}}$ is the predicted viral load after 30 days ($\frac{\text{copies}}{\text{mL}}$)}
              \item{${N_{\text{o}}}$ is the initial viral load ($\frac{\text{copies}}{\text{mL}}$)}
              \item{$λ$ is the elimination constant ($\text{s}^{-1}$)}
              \item{$t$ is the time (${\text{s}}$)}
              \end{symbDescription}
